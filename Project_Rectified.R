...
Data = function()
{
  ...
  tic()
  DataMatrix1 = generateData(n = n_train,d = d_train,mu = Mu_train1,Sigma = Sigma_train1,
  ...
  TDataMatrix1 = rmvnorm(n = n_test,mean = Mu_test1,sigma = Sigma_test1)
  ...
  L = list(X_MCD_Depth,TX_MCD_Depth,X_2SGS_Depth,TX_2SGS_Depth,X_DI_Depth,TX_DI_Depth,
           X_Original_Depth,TX_Original_Depth,D,TD)
  toc()
  return(L)
}
