...
Data = function()
{
  ...
  tic()
  DataMatrix1 = generateC(n = n_train,mu = Mu_train1,S = Sigma_train1,
  ...
  DataMatrix2 = LaplacesDemon::rmvc(n = n_train,mu = Mu_train2,S = Sigma_train2)
  ...
  #DDC
  estim2_DDC = DDC(DataMatrix2)
  Mu2_DDC = estim2_DDC$locX              ##Estimate of Mu
  Sigma2_DDC = estim2_DDC$scaleX          ##Estimate of Sigma
  ...
  TDataMatrix1 = generateC(n = n_test,mu = Mu_test1,S = Sigma_test1,
                           perout = percent,gamma = gamma,outlierType = "cellwisePlain")$X
  ...
  TDataMatrix2 = LaplacesDemon::rmvc(n = n_test,mu = Mu_test2,S = Sigma_test2)
