...
Data = function()
{
  ...
  tic()
  DataMatrix1 = generateL(n = n_train,mu = Mu_train1,S = Sigma_train1,
  ...
  DataMatrix2 = LaplacesDemon::rmvl(n = n_train,mu = Mu_train2,Sigma = Sigma_train2)
  ...
  TDataMatrix1 = generateL(n = n_test,mu = Mu_test1,S = Sigma_test1,
                           perout = percent,gamma = gamma,outlierType = "cellwisePlain")$X
  ...
  TDataMatrix2 = LaplacesDemon::rmvl(n = n_test,mu = Mu_test2,Sigma = Sigma_test2)
  ...
  L = list(X_MCD,TX_MCD,X_2SGS,TX_2SGS,X_DI,TX_DI,X_Original,TX_Original,X_MCD_Depth,TX_MCD_Depth,
           X_2SGS_Depth,TX_2SGS_Depth,X_DI_Depth,TX_DI_Depth,X_Original_Depth,TX_Original_Depth,DataMatrix,TDataMatrix)
  toc()
  return(L)
}
